        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InventoryName = table.Column<string>(type: "nvarchar(160)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductName = table.Column<string>(type: "nvarchar(160)", maxLength: 150, nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    Price = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoneBy = table.Column<string>(type: "nvarchar(160)", nullable: false),
                    PONumber = table.Column<string>(type: "nvarchar(32)", nullable: false),
                    ProductionNumber = table.Column<string>(type: "nvarchar(32)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DoneBy = table.Column<string>(type: "nvarchar(160)", nullable: false),
                    SONumber = table.Column<string>(type: "nvarchar(32)", nullable: false),
                    ProductionNumber = table.Column<string>(type: "nvarchar(32)", nullable: false)
                },
                constraints: table =>
                {
